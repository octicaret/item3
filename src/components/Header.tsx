        ...
        <div className="block md:hidden">
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="flex items-center space-x-2 shrink-0">
              ...
              >
                <img src="https://cdn.itemsatis.com/avatar/global/Avatar30.png" className="w-full h-full object-cover" alt="Profilim" />
              </button>
            </div>
          </div>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden fixed inset-0 top-[102px] bg-[#141724]/95 backdrop-blur-xl z-50 p-4 border-t border-white/10 overflow-y-auto animate-in slide-in-from-top-2">
          <div className="space-y-3">
            ...
            >
              <img src="https://cdn.itemsatis.com/avatar/global/Avatar30.png" className="w-5 h-5 rounded-full object-cover bg-transparent shadow-md" alt="Profilim" />
              <span>Profilim</span>
            </button>
