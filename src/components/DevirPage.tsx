      ...
      <main className="md:hidden flex-1 flex flex-col bg-[#1e1f29] relative pb-20">
        ...
        <div className="relative flex flex-col items-center mt-[35px] px-4">
          <div className="w-28 h-28 rounded-3xl border-4 border-[#1e1f29] bg-transparent overflow-hidden shadow-md z-10">
            <img 
              src="https://cdn.itemsatis.com/avatar/global/avatar-2.png" 
              alt="Avatar" 
          ...
          <div className="flex items-center gap-3 mt-3">
            <span className="text-white font-bold text-base tracking-wide">furkanozden126</span>
        ...
        <div className="grid grid-cols-2 gap-3 px-4 py-4 mt-2">
          ...
          <div 
            onClick={() => handleListingClick('???? CHAMPIONS 2023 VANDAL İLE DOLU HESAP! ????')}
          ...
          >
            <div className="w-full aspect-[16/10] overflow-hidden bg-[#2a2f4a] relative">
              <img 
                src="https://cdn.itemsatis.com/uploads/post_images/champions-2023-vandal-ile-dolu-hesap-3405193.png" 
                alt="Valorant Hesap" 
            ...
            <div className="p-3">
              ...
              <div className="text-xs font-bold text-white uppercase leading-snug line-clamp-2 h-8 mb-3">
                ???? CHAMPIONS 2023 VANDAL İLE DOLU HESAP! ????
              </div>
              <div className="text-sm font-black text-[#ffb800]">7.500,00 ₺</div>
            </div>
          </div>
        </div>
          ...
          <div className="px-6 pt-6 pb-4 bg-[#181724]">
            ...
            <div className="flex justify-end items-center mb-2">
              <div className="flex items-center space-x-1.5 text-xs text-[#8a899a]">
                ...
                <span>Üyelik Tarihi: <strong className="text-gray-300 font-normal">16 kasım 2022</strong></span>
              </div>
            </div>
              ...
              <div className="flex items-start sm:items-center space-x-5">
                ...
                <div className="flex flex-col space-y-2">
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    <h1 className="text-xl sm:text-2xl font-bold text-white tracking-wide">furkanozden126</h1>
          ...
          <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 items-start content-start">
            ...
            >
              ...
              <div className="p-4 flex flex-col bg-[#2a2936]">
                ...
                <span className="text-sm font-bold text-[#dfa841]">7.500,00 ₺</span>
              </div>
            </article>
          </div>
